                      ...
                      background: Stack(
                        children: [
                          ...
                          Container(
                              ...
                              child:
                                  controller.getYoutubeList().isNotEmpty == true
                                      ? IconButton(
                                          onPressed: () => {
                    ...
                    controller.savedClicked.value == false
                        ? IconButton(
                            onPressed: () => {
                              ...
                              controller.addMovie(controller.movieResult)
                            },
                            icon: const IconTheme(
                              data:
                        ...
                        : IconButton(
                            onPressed: () => {
                              controller.savedClicked.value = false,
                              controller.deleteMovie(controller.movieResult.id!)
                            },
                            icon: const IconTheme(
                              data:
                                  IconThemeData(color: Colors.white, size: 25),
                ...
                children: [
                  Container(
                    ...
                    child: Flex(
                      ...
                      children: [
                        Expanded(
                            child: Text("${controller.movieResult.overview}"))
                      ],
                    ),
                  ),
                  SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return InkWell(
                            ...
                            child: Hero(
                              tag:
                                  "animate${controller.getCastList()[index].id}",
                  ...
                  SizedBox(
                      ...
                      child: ListView.builder(
                        scrollDirection: Axis.horizontal,
                        itemCount: controller.getSimilarMovieList().length,
                        itemBuilder: (BuildContext context, int index) {
                          return InkWell(
                            onTap: () {
                              controller.onTapItem.value = true;
                              controller.detailScreen(
                                  controller.getSimilarMovieList()[index],
                                  context);
                            },
                            child: listItemPosterMovies(
                                context,
